...
import logging
from src.utils import get_batch, estimate_loss, load_data, load_train_config, get_all_files_in_directory
...
def post_train(file_name, out_dir, load_model = False):
    ...
    batch_size, block_size, max_iters, eval_interval, learning_rate, eval_iters, device, num_file, epochs = load_train_config(os.path.join(pwd, "./config/train.json"))
